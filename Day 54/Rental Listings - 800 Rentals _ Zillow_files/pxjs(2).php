(function jvxPixelWrapper(){
    ...
    var existingGroups = {};
    var domain = "generic";
    var pixelParams = {"px":"76035629dc9df9","cData":"SRP"};
    var gdprParams = "";
    var addnlPixelData = function getRetargetingData() {
var temp;
if(existingData.length == 0){
temp = pixelParams.cData + "_1";
}else if(pixelParams.cData == existingData[0].split("_")[0] && parseInt(existingData[0].split("_")[1]) >= 30){
temp = existingData[0].split("_")[0] + "_30";
}else if(pixelParams.cData == existingData[0].split("_")[0]){
temp = existingData[0].split("_")[0] + "_" + (parseInt(existingData[0].split("_")[1]) + 1);
}else if(pixelParams.cData != existingData[0].split("_")[0]){
temp = pixelParams.cData + "_1";
}
return [temp];
